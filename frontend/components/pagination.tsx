...
import { getRangeProps, PaginationProps } from './types';



export const getPageRange = ({ activePage, numOfPages }: getRangeProps): number[] => {
    if (numOfPages <= 5) {
    ...
    return (
        <>
            <div className="pagination">
                ...
                <>
                    {getPageRange({ activePage, numOfPages }).map(page => (
